...
/* Device IDs (I2C HID - same node for all modes, no replug on mode switch) */
#define FU_LXSTOUCH_VID      0x1FD2 /* VID is the same for both modes */
#define FU_LXSTOUCH_PID_APP  0x5010 /* App mode: normal operation (SWIP) */
#define FU_LXSTOUCH_PID_BOOT 0xB001 /* Boot mode: App missing or corrupt (DFUP) */

...
typedef struct Logi__Device__Proto__SendCrashDumpResponse
    Logi__Device__Proto__SendCrashDumpResponse;
typedef struct Logi__Device__Proto__SendCrashDumpRequestv2
    Logi__Device__Proto__SendCrashDumpRequestv2;
typedef struct Logi__Device__Proto__SendCrashDumpResponsev2
...
typedef struct Logi__Device__Proto__CrashDumpAvailableEvent
    Logi__Device__Proto__CrashDumpAvailableEvent;
typedef struct Logi__Device__Proto__GenerateCrashDumpRequest
    Logi__Device__Proto__GenerateCrashDumpRequest;
typedef struct Logi__Device__Proto__GenerateCrashDumpResponse

...
typedef struct Logi__Device__Proto__TransitionToDeviceModeRequest
    Logi__Device__Proto__TransitionToDeviceModeRequest;
typedef struct Logi__Device__Proto__TransitionToDeviceModeResponse
    Logi__Device__Proto__TransitionToDeviceModeResponse;
typedef struct Logi__Device__Proto__SetDeprovisionRequest
    Logi__Device__Proto__SetDeprovisionRequest;
typedef struct Logi__Device__Proto__SetDeprovisionResponse
    Logi__Device__Proto__SetDeprovisionResponse;
typedef struct Logi__Device__Proto__SendCertificateDataRequest
    Logi__Device__Proto__SendCertificateDataRequest;
typedef struct Logi__Device__Proto__SendCertificateDataResponse
...
typedef enum _Logi__Device__Proto__SendCertificateDataRequest__CertType {
	...
	LOGI__DEVICE__PROTO__SEND_CERTIFICATE_DATA_REQUEST__CERT_TYPE__NET_CONFIG =
		...
		LOGI__DEVICE__PROTO__SEND_CERTIFICATE_DATA_REQUEST__CERT_TYPE)
...
#define LOGI__DEVICE__PROTO__SEND_CERTIFICATE_DATA_REQUEST__INIT                                   \
	{                                                                                          \
		...
		, LOGI__DEVICE__PROTO__SEND_CERTIFICATE_DATA_REQUEST__CERT_TYPE__RESERVED,         \

...
typedef struct Logi__Device__Proto__SetSpeakerBoostRequest Logi__Device__Proto__SetSpeakerBoostRequest;
typedef struct Logi__Device__Proto__SetSpeakerBoostResponse Logi__Device__Proto__SetSpeakerBoostResponse;
typedef struct Logi__Device__Proto__SetNoiseReductionRequest Logi__Device__Proto__SetNoiseReductionRequest;
typedef struct Logi__Device__Proto__SetNoiseReductionResponse Logi__Device__Proto__SetNoiseReductionResponse;
typedef struct Logi__Device__Proto__SetReverbModeRequest Logi__Device__Proto__SetReverbModeRequest;
typedef struct Logi__Device__Proto__SetReverbModeResponse Logi__Device__Proto__SetReverbModeResponse;
...
typedef enum _Logi__Device__Proto__SetReverbModeRequest__ReverbMode {
  ...
  LOGI__DEVICE__PROTO__SET_REVERB_MODE_REQUEST__REVERB_MODE__AGGRESSIVE = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(LOGI__DEVICE__PROTO__SET_REVERB_MODE_REQUEST__REVERB_MODE)
...
#define LOGI__DEVICE__PROTO__SET_SPEAKER_BOOST_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&logi__device__proto__set_speaker_boost_request__descriptor) \
    , 0 }
...
struct  Logi__Device__Proto__SetSpeakerBoostResponse
{
  ...
  /*
   **
   * (REQUIRED) set to true if the audio setting request was successfully sent, false otherwise
   */
  protobuf_c_boolean success;
};
#define LOGI__DEVICE__PROTO__SET_SPEAKER_BOOST_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&logi__device__proto__set_speaker_boost_response__descriptor) \
    , 0 }
...
#define LOGI__DEVICE__PROTO__SET_NOISE_REDUCTION_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&logi__device__proto__set_noise_reduction_request__descriptor) \
    , 0 }
...
#define LOGI__DEVICE__PROTO__SET_NOISE_REDUCTION_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&logi__device__proto__set_noise_reduction_response__descriptor) \
    , 0 }
...
#define LOGI__DEVICE__PROTO__SET_REVERB_MODE_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&logi__device__proto__set_reverb_mode_response__descriptor) \
    , 0 }
...
extern const ProtobufCMessageDescriptor logi__device__proto__set_noise_reduction_request__descriptor;
extern const ProtobufCMessageDescriptor logi__device__proto__set_noise_reduction_response__descriptor;
extern const ProtobufCMessageDescriptor logi__device__proto__set_reverb_mode_request__descriptor;
extern const ProtobufCEnumDescriptor    logi__device__proto__set_reverb_mode_request__reverb_mode__descriptor;

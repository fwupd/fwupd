...
typedef enum {
	...
	LOGI__DEVICE__PROTO__USB_MSG__MESSAGE_EVENT =
	    5 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(LOGI__DEVICE__PROTO__USB_MSG__MESSAGE__CASE)
...
typedef enum {
	...
	LOGI__DEVICE__PROTO__REQUEST__PAYLOAD_SEND_CERTIFICATE_DATA_REQUEST =
	    19 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(LOGI__DEVICE__PROTO__REQUEST__PAYLOAD__CASE)
...
typedef enum {
	...
	LOGI__DEVICE__PROTO__RESPONSE__PAYLOAD_SEND_CERTIFICATE_DATA_RESPONSE =
	    19 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(LOGI__DEVICE__PROTO__RESPONSE__PAYLOAD__CASE)
...
typedef enum {
	...
	LOGI__DEVICE__PROTO__EVENT__PAYLOAD_HANDSHAKE_EVENT =
	    4 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(LOGI__DEVICE__PROTO__EVENT__PAYLOAD__CASE)
...
logi__device__proto__usb_msg__unpack(ProtobufCAllocator *allocator,
				     size_t len,
				     const uint8_t *data);
void
...
logi__device__proto__request__unpack(ProtobufCAllocator *allocator,
				     size_t len,
				     const uint8_t *data);
void
...
typedef void (*Logi__Device__Proto__Header_Closure)(const Logi__Device__Proto__Header *message,
						    void *closure_data);
...
typedef void (*Logi__Device__Proto__HandshakeEvent_Closure)(
    const Logi__Device__Proto__HandshakeEvent *message,
    void *closure_data);
typedef void (*Logi__Device__Proto__UsbMsg_Closure)(const Logi__Device__Proto__UsbMsg *message,
						    void *closure_data);
typedef void (*Logi__Device__Proto__Request_Closure)(const Logi__Device__Proto__Request *message,
						     void *closure_data);
typedef void (*Logi__Device__Proto__Response_Closure)(const Logi__Device__Proto__Response *message,
						      void *closure_data);
typedef void (*Logi__Device__Proto__Event_Closure)(const Logi__Device__Proto__Event *message,
						   void *closure_data);

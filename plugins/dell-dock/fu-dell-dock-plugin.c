...
const DellDockComponent dock_component_hub[] = {
    ...
    {DOCK_BASE_TYPE_K2, DELL_VID, DELL_DOCK_USB_RTS5480_G1_PID, "USB\\VID_413C&PID_B0A1&k2_hub"},
    {DOCK_BASE_TYPE_K2, DELL_VID, DELL_DOCK_USB_RTS5480_G2_PID, "USB\\VID_413C&PID_B0A2&k2_hub"},
...
const DellDockComponent dock_component_pkg[] = {
    ...
    {DOCK_BASE_TYPE_K2, 0x0, 0x0, "USB\\VID_413C&PID_B06E&hub&k2_status"},
    {DOCK_BASE_TYPE_UNKNOWN, 0, 0, NULL},
};
...
fu_dell_dock_plugin_probe_ec_v2_subcomponents(FuPlugin *plugin, FuDevice *ec_device, GError **error)
{
	...
	/* PACKAGE */
	{
		...
		status_device = fu_dell_dock_status_new(ctx);
		instance_id = fu_dell_dock_get_instance_id(base_type, dock_component_pkg, 0, 0);

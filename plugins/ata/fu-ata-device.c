...
fu_ata_device_probe(FuDevice *device, GError **error)
{
	...
	self->pci_depth = fu_linux_device_get_subsystem_depth(FU_LINUX_DEVICE(device), "pci");
	self->usb_depth = fu_linux_device_get_subsystem_depth(FU_LINUX_DEVICE(device), "usb");

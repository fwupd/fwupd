...
fu_starlabs_coreboot_device_init(FuStarlabsCorebootDevice *self)
{
	...
	fu_device_set_details_url(FU_DEVICE(self), FU_BIOS_PLUGIN_STARLABS_SUPPORT_URL);
	fu_device_set_id(FU_DEVICE(self), "star-labs-coreboot-manual-update");
	fu_device_set_name(FU_DEVICE(self), "Star Labs Coreboot Firmware");
	...
	g_string_append_printf(msg,
			       ...
			       "fwupd support is removed. Follow: %s",
			       FU_BIOS_PLUGIN_STARLABS_SUPPORT_URL);

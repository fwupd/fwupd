...
gboolean	 fu_kinetic_mst_connection_rc_set_command 	(FuKineticMstConnection *self,
								 guint32	 rc_cmd,
								 guint32	 length,
								 guint32	 offset,
								 const guint8	*buf,
...
gboolean	 fu_kinetic_mst_connection_rc_get_command 	(FuKineticMstConnection *self,
								 guint32	 rc_cmd,
								 guint32	 length,
								 guint32	 offset,
								 guint8		*buf,
...
gboolean	 fu_kinetic_mst_connection_rc_special_get_command(FuKineticMstConnection *self,
								 guint32	 rc_cmd,
								 guint32	 cmd_length,
								 guint32	 cmd_offset,
								 guint8		*cmd_data,
...
gboolean	 fu_kinetic_mst_connection_enable_rc		(FuKineticMstConnection *self,
								 GError **error);

gboolean	 fu_kinetic_mst_connection_disable_rc		(FuKineticMstConnection *self,
								 GError **error);

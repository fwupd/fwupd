...
void		fu_ccgx_cyacd_firmware_set_device_info (FuCcgxCyacdFirmware *self, FWImageType fw_image_type ,guint16 silicon_id, guint16 app_type) ;
guint32 	fu_ccgx_cyacd_firmware_get_info_count (FuCcgxCyacdFirmware *self);
CyacdFileInfo	*fu_ccgx_cyacd_firmware_get_info_data (FuCcgxCyacdFirmware *self, guint32 index);

...
//#define DEBUG_FUNC_NAME g_print("%s: %s\n",__FILE__,__func__)
//#define DEBUG_FUNC_NAME do {} while(0)

void		fu_ccgx_util_init_elapsed_time (struct timeval  *start_time);
guint64		fu_ccgx_util_get_elapsed_time_ms (struct timeval  *start_time);

...
gboolean	fu_ccgx_i2c_read		(FuDevice		*device,
						 CyI2CDeviceHandle	*handle,
						 CyI2CDataConfig	*data_cfg,
						 CyDataBuffer		*data_buffer,
						 GError			**error);
gboolean	fu_ccgx_i2c_write		(FuDevice		*device,
						 CyI2CDeviceHandle	*handle,
						 CyI2CDataConfig	*data_cfg,
						 CyDataBuffer		*data_buffer,
						 GError			**error);
gboolean	fu_ccgx_i2c_write_no_resp	(FuDevice		*device,
						 CyI2CDeviceHandle	*handle,
						 CyI2CDataConfig	*data_cfg,
						 CyDataBuffer		*data_buffer,
						 GError			**error);
gboolean	fu_ccgx_i2c_get_config		(FuDevice		*device,
						 CyI2CDeviceHandle	*handle,
						 CyI2CConfig		*i2c_config,
						 GError			**error);
gboolean	fu_ccgx_i2c_set_config		(FuDevice		*device,
						 CyI2CDeviceHandle	*handle,
						 CyI2CConfig		*i2c_config,
						 GError			**error);

...
static void fu_algoltek_usb_plugin_init(FuAlgoltekUsbPlugin *self) {
}

static void fu_algoltek_usb_plugin_constructed(GObject *obj) {
...
static void fu_algoltek_usb_plugin_class_init(FuAlgoltekUsbPluginClass *klass) {

...
/**
 * fu_realtek_billboard_plugin_init:
 * @self: a #FuRealtekBillboardPlugin
 *
...
/**
 * fu_realtek_billboard_plugin_constructed:
 * @obj: a #FuRealtekBillboardPlugin
 *
 * Adds the udev subsystem and device type for the plugin.
 **/
static void
...
/**
 * fu_realtek_billboard_plugin_class_init:
 * @klass: a #FuRealtekBillboardPluginClass
 *
 * Initializes the plugin class, registering the vfuncs.
 **/
static void

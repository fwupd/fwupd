...
static guint8
fu_goodixfp_crc8 (guint8 *buf, guint32 bufsz)
{
...
void 
fu_goodixfp_build_header (GxfpPkgHeader *pheader,
			  guint16 len,
			  guint8 cmd0,
			  guint8 cmd1,
		  	  guint8 pkg_flag)
...
gboolean
fu_goodixfp_parse_header (guint8 *buf,
			  guint32 bufsz,

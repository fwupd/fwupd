...
G_DEFINE_TYPE (FuThunderboltFirmwareUpdate, fu_thunderbolt_firmware_update, FU_TYPE_THUNDERBOLT_FIRMWARE)
						...
						GError **error)
{
	...
	guint32 tmp = 0;
	if (!fu_thunderbolt_firmware_read_location (tbt, section, offset,

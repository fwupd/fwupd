...
typedef enum {
	FU_VLI_DEVICE_I2C_STATUS_OK,
	FU_VLI_DEVICE_I2C_STATUS_HEADER,
	FU_VLI_DEVICE_I2C_STATUS_COMMAND,
	FU_VLI_DEVICE_I2C_STATUS_ADDRESS,
	FU_VLI_DEVICE_I2C_STATUS_PACKETSIZE,
	FU_VLI_DEVICE_I2C_STATUS_CHECKSUM,
} FuVliDeviceI2cStatus;

/* Texas Instruments BSL */
#define FU_VLI_I2C_ADDR_WRITE			0x18
#define FU_VLI_I2C_ADDR_READ			0x19

#define FU_VLI_I2C_CMD_WRITE			0x32
#define FU_VLI_I2C_CMD_READ_STATUS		0x33
#define FU_VLI_I2C_CMD_UPGRADE			0x34
#define FU_VLI_I2C_CMD_READ_VERSIONS		0x40

#define FU_VLI_I2C_R_VDR			0xa0	/* read vendor comand */
#define FU_VLI_I2C_W_VDR			0xb0	/* write vendor comand */
...
gboolean	 fu_vli_common_i2c_status_check		(FuVliDeviceI2cStatus	 status,
							 GError			**error);

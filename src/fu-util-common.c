...
void
fu_util_print_json_object(FuConsole *console, FwupdJsonObject *json_object)
{
...
fu_util_print_error_as_json(FuConsole *console, const GError *error)
{
	...
	fwupd_json_object_add_string(json_object_tmp, "Domain", g_quark_to_string(error->domain));
	fwupd_json_object_add_integer(json_object_tmp, "Code", error->code);
	fwupd_json_object_add_string(json_object_tmp, "Message", error->message);
	fwupd_json_object_add_object(json_object, "Error", json_object_tmp);
	fu_util_print_json_object(console, json_object);
}
...
void
fu_util_project_versions_print_json(FuConsole *console, GHashTable *metadata)
{
	GHashTableIter iter;
	const gchar *key;
	const gchar *value;
	...
	while (g_hash_table_iter_next(&iter, (gpointer *)&key, (gpointer *)&value)) {
		...
		fwupd_json_object_add_string(json_object, "AppstreamId", project);
		fwupd_json_object_add_string(json_object, "Version", value);
		fwupd_json_array_add_object(json_array, json_object_tmp);
	}
	fwupd_json_object_add_array(json_object, "Versions", json_array);
	fu_util_print_json_object(console, json_object);
}

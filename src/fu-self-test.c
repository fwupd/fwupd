...
fu_engine_history_func (void)
{
	...
	fwupd_release_set_vendor (fu_device_get_release_default (device2), NULL);
...
fu_history_func (void)
{
	...
	fwupd_release_set_vendor (release, "FwupdVersion=" VERSION);
	...
	g_assert_cmpstr (fwupd_release_get_vendor (release), ==, "FwupdVersion=" VERSION);

...
static void
fu_engine_requirements_phased_update_func(gconstpointer user_data)
{
	FuTest *self = (FuTest *)user_data;
	gboolean ret;
	g_autoptr(XbNode) component = NULL;
...
main(int argc, char **argv)
{
	...
	g_test_add_data_func("/fwupd/engine{requirements-phased-updates}",
			     self,
			     fu_engine_requirements_phased_update_func);

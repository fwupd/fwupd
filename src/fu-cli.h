...
void
fu_cli_display_current_message(FuCli *self) G_GNUC_NON_NULL(1);
gboolean
fu_cli_prompt_complete(FuCli *self, gboolean prompt, GError **error) G_GNUC_NON_NULL(1);
void
fu_cli_set_current_operation(FuCli *self, FuCliOperation current_operation) G_GNUC_NON_NULL(1);
gint

...
gboolean
fu_cli_bios_setting_matches_args(FwupdBiosSetting *setting, gchar **values) G_GNUC_NON_NULL(1, 2);
void
fu_cli_bios_setting_console_print(FuConsole *console, gchar **values, GPtrArray *settings)
    G_GNUC_NON_NULL(1, 2, 3);
GHashTable *
fu_cli_bios_settings_parse_argv(gchar **input, GError **error) G_GNUC_NON_NULL(1);

...
main(int argc, char **argv)
{
	...
	g_test_add_data_func("/fwupd/release/compare", ctx, fu_release_compare_func);
	g_test_add_func("/fwupd/release/uri-scheme", fu_release_uri_scheme_func);
	g_test_add_data_func("/fwupd/release/trusted-report", ctx, fu_release_trusted_report_func);

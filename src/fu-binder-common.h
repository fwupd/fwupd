...
enum fu_binder_call {
	...
	FWUPD_BINDER_CALL_GET_HWIDS,
	FWUPD_BINDER_CALL_EMULATION_TAG,
	FWUPD_BINDER_CALL_EMULATION_UNTAG,
	FWUPD_BINDER_CALL_EMULATION_LOAD,
	FWUPD_BINDER_CALL_EMULATION_SAVE,
	FWUPD_BINDER_CALL_MODIFY_DEVICE,
	/*< private >*/

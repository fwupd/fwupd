...
#define fu_device_add_icon(d,v)			fwupd_device_add_icon(fwupd_result_get_device(FWUPD_RESULT(d)),v)
...
#define fu_device_get_icons(d)			fwupd_device_get_icons(fwupd_result_get_device(FWUPD_RESULT(d)))

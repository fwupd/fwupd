...
#define fu_device_set_alternate_guid(d,v)	fwupd_result_set_alternate_guid(FWUPD_RESULT(d),v)
...
#define fu_device_get_alternate_guid(d)		fwupd_result_get_alternate_guid(FWUPD_RESULT(d))

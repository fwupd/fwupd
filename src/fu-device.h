...
#define fu_device_set_update_remote_id(d,v)	fwupd_result_set_update_remote_id(FWUPD_RESULT(d),v)
...
#define fu_device_get_update_remote_id(d)	fwupd_result_get_update_remote_id(FWUPD_RESULT(d))

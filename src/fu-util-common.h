...
void
fu_util_print_json_object(FuConsole *console, FwupdJsonObject *json_object) G_GNUC_NON_NULL(1, 2);
void
...
void
fu_util_project_versions_print_json(FuConsole *console, GHashTable *metadata) G_GNUC_NON_NULL(1, 2);
const gchar *

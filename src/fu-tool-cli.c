...
static void
fu_tool_cli_update_device_request_cb(FuEngine *engine, FwupdRequest *request, FuToolCli *self)
{
...
static void
fu_tool_cli_update_device_changed_cb(FuEngine *engine, FwupdDevice *device, FuToolCli *self)
{
...
static gboolean
fu_tool_cli_sync_impl_emulation_load(FwupdClient *client,
				     const gchar *filename,
				     gpointer user_data,
				     GCancellable *cancellable,
				     GError **error)
...
static gboolean
fu_tool_cli_sync_impl_emulation_save(FwupdClient *client,
				     const gchar *filename,
				     gpointer user_data,
				     GCancellable *cancellable,
				     GError **error)
...
static GPtrArray *
fu_tool_cli_sync_impl_get_details(FwupdClient *client,
				  const gchar *filename,
				  gpointer user_data,
				  GCancellable *cancellable,
				  GError **error)
...
static GPtrArray *
fu_tool_cli_sync_impl_get_host_security_attrs(FwupdClient *client,
					      gpointer user_data,
					      GCancellable *cancellable,
					      GError **error)
{
...
static GPtrArray *
fu_tool_cli_sync_impl_get_host_security_events(FwupdClient *client,
					       guint limit,
					       gpointer user_data,
					       GCancellable *cancellable,
					       GError **error)
...
static gboolean
fu_tool_cli_sync_impl_install(FwupdClient *client,
			      const gchar *device_id,
			      const gchar *filename,
			      ...
			      GError **error)
{
	...
	/* handle both forms */
	device = fu_tool_cli_get_device(self, device_id, error);
	if (device == NULL)
		return FALSE;
	devices_possible = fu_engine_get_devices_by_composite_id(self->engine,
...
static gboolean
fu_tool_cli_sync_impl_install_release(FwupdClient *client,
				      FwupdDevice *device,
				      ...
				      GError **error)
{
	...
	g_ptr_array_add(devices, g_object_ref(device));
	fu_progress_reset(self->progress);
	return fu_tool_cli_install_stream(self, stream, devices, self->progress, error);
}
...
static gboolean
fu_tool_cli_sync_impl_refresh_remote(FwupdClient *client,
				     FwupdRemote *remote,
				     FwupdClientDownloadFlags download_flags,
				     gpointer user_data,
				     GCancellable *cancellable,
...
static gboolean
fu_tool_cli_sync_impl_reset_config(FwupdClient *client,
				   const gchar *section,
				   gpointer user_data,
				   GCancellable *cancellable,
				   GError **error)
...
static gboolean
fu_tool_cli_sync_impl_set_feature_flags(FwupdClient *client,
					...
					GError **error)
{
	...
	if (!fu_console_get_interactive(fu_cli_get_console(FU_CLI(self)))) {
...
static gboolean
fu_tool_cli_sync_impl_update_metadata(FwupdClient *client,
				      const gchar *remote_id,
...
static gboolean
fu_tool_cli_sync_impl_verify(FwupdClient *client,
			     const gchar *device_id,
			     gpointer user_data,
			     GCancellable *cancellable,
			     GError **error)
...
static gboolean
fu_tool_cli_sync_impl_verify_update(FwupdClient *client,
				    const gchar *device_id,
				    gpointer user_data,
				    GCancellable *cancellable,
				    GError **error)
...
{ /* nocheck:lines */
	...
	static FwupdClientSyncImpl impl = {
	    ...
	    .emulation_load = fu_tool_cli_sync_impl_emulation_load,
	    .emulation_save = fu_tool_cli_sync_impl_emulation_save,
	    .get_bios_settings = fu_tool_cli_sync_impl_get_bios_settings,
	    .get_details = fu_tool_cli_sync_impl_get_details,
	    ...
	    .get_host_security_attrs = fu_tool_cli_sync_impl_get_host_security_attrs,
	    .get_host_security_events = fu_tool_cli_sync_impl_get_host_security_events,
	    ...
	    .install = fu_tool_cli_sync_impl_install,
	    .install_release = fu_tool_cli_sync_impl_install_release,
	    ...
	    .refresh_remote = fu_tool_cli_sync_impl_refresh_remote,
	    .reset_config = fu_tool_cli_sync_impl_reset_config,
	    .search = fu_tool_cli_sync_impl_search,
	    .set_feature_flags = fu_tool_cli_sync_impl_set_feature_flags,
	    .update_metadata = fu_tool_cli_sync_impl_update_metadata,
	    .verify = fu_tool_cli_sync_impl_verify,
	    .verify_update = fu_tool_cli_sync_impl_verify_update,
	};

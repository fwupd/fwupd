...
gboolean
fu_device_has_private_flag_quark(FuDevice *self, GQuark flag_quark) G_GNUC_NON_NULL(1) G_GNUC_PURE;
GQuark
...
gboolean
fu_device_has_parent_guid(FuDevice *self, const gchar *guid) G_GNUC_NON_NULL(1, 2) G_GNUC_PURE;
GPtrArray *
fu_device_get_parent_physical_ids(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
gboolean
fu_device_has_parent_physical_id(FuDevice *self, const gchar *physical_id)
    G_GNUC_NON_NULL(1, 2) G_GNUC_PURE;
GPtrArray *
fu_device_get_parent_backend_ids(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
gboolean
...
gint
fu_device_get_order(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fu_device_set_order(FuDevice *self, gint order) G_GNUC_NON_NULL(1);
const gchar *
fu_device_get_update_request_id(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
gboolean
fu_device_is_updatable(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
const gchar *
...
FuDevice *
fu_device_get_proxy_internal(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
FuDevice *
fu_device_get_parent_internal(FuDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
...
FuBackend *
fu_device_get_backend(FuDevice *self) G_GNUC_PURE;
void

...
guint32
fu_crc32_done(FuCrcKind kind, guint32 crc) G_GNUC_CONST;
guint32
...
guint16
fu_crc16_done(FuCrcKind kind, guint16 crc) G_GNUC_CONST;

guint8
fu_crc8_step(FuCrcKind kind, const guint8 *buf, gsize bufsz, guint8 crc) G_GNUC_PURE;
guint8
fu_crc8_done(FuCrcKind kind, guint8 crc) G_GNUC_CONST;

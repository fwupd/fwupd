...
GQuark FU_DEVICE_PRIVATE_FLAG_NO_AUTO_INSTANCE_IDS;
// no-auto-instance-ids")
GQuark FU_DEVICE_PRIVATE_FLAG_ENSURE_SEMVER;
// ensure-semver")
GQuark FU_DEVICE_PRIVATE_FLAG_ONLY_SUPPORTED;
// only-supported")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_NAME;
// md-set-name")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_NAME_CATEGORY;
// md-set-name-category")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_VERFMT;
// md-set-verfmt")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_ICON;
// md-set-icon")
GQuark FU_DEVICE_PRIVATE_FLAG_RETRY_OPEN;
// retry-open")
GQuark FU_DEVICE_PRIVATE_FLAG_REPLUG_MATCH_GUID;
// replug-match-guid")
GQuark FU_DEVICE_PRIVATE_FLAG_INHERIT_ACTIVATION;
// inherit-activation")
GQuark FU_DEVICE_PRIVATE_FLAG_IS_OPEN;
// is-open")
GQuark FU_DEVICE_PRIVATE_FLAG_NO_SERIAL_NUMBER;
// no-serial-number")
GQuark FU_DEVICE_PRIVATE_FLAG_AUTO_PARENT_CHILDREN;
// auto-parent-children")
GQuark FU_DEVICE_PRIVATE_FLAG_ATTACH_EXTRA_RESET;
// attach-extra-reset")
GQuark FU_DEVICE_PRIVATE_FLAG_INHIBIT_CHILDREN;
// inhibit-children")
GQuark FU_DEVICE_PRIVATE_FLAG_NO_AUTO_REMOVE_CHILDREN;
// no-auto-remove-children")
GQuark FU_DEVICE_PRIVATE_FLAG_USE_PARENT_FOR_OPEN;
// use-parent-for-open")
GQuark FU_DEVICE_PRIVATE_FLAG_USE_PARENT_FOR_BATTERY;
// use-parent-for-battery")
GQuark FU_DEVICE_PRIVATE_FLAG_USE_PROXY_FALLBACK;
// use-proxy-fallback")
GQuark FU_DEVICE_PRIVATE_FLAG_NO_AUTO_REMOVE;
// no-auto-remove")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_VENDOR;
// md-set-vendor")
GQuark FU_DEVICE_PRIVATE_FLAG_NO_LID_CLOSED;
// no-lid-closed")
GQuark FU_DEVICE_PRIVATE_FLAG_NO_PROBE;
// no-probe")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_SIGNED;
// md-set-signed")
GQuark FU_DEVICE_PRIVATE_FLAG_AUTO_PAUSE_POLLING;
// auto-pause-polling")
GQuark FU_DEVICE_PRIVATE_FLAG_DELAYED_REMOVAL;
// delayed-removal")
GQuark FU_DEVICE_PRIVATE_FLAG_IGNORE_SYSTEM_POWER;
// ignore-system-power")
GQuark FU_DEVICE_PRIVATE_FLAG_SAVE_INTO_BACKUP_REMOTE;
// save-into-backup-remote")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_FLAGS;
// md-set-flags")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_VERSION;
// md-set-version")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_ONLY_CHECKSUM;
// md-only-checksum")
GQuark FU_DEVICE_PRIVATE_FLAG_ADD_INSTANCE_ID_REV;
// add-instance-id-rev")
GQuark FU_DEVICE_PRIVATE_FLAG_UNCONNECTED;
// unconnected")
GQuark FU_DEVICE_PRIVATE_FLAG_DISPLAY_REQUIRED;
// display-required")
GQuark FU_DEVICE_PRIVATE_FLAG_UPDATE_PENDING;
// update-pending")
GQuark FU_DEVICE_PRIVATE_FLAG_NO_GENERIC_GUIDS;
// no-generic-guids")
GQuark FU_DEVICE_PRIVATE_FLAG_ENFORCE_REQUIRES;
// enforce-requires")
GQuark FU_DEVICE_PRIVATE_FLAG_HOST_FIRMWARE;
// host-firmware")
GQuark FU_DEVICE_PRIVATE_FLAG_HOST_FIRMWARE_CHILD;
// host-firmware-child")
GQuark FU_DEVICE_PRIVATE_FLAG_HOST_CPU;
// host-cpu")
GQuark FU_DEVICE_PRIVATE_FLAG_HOST_CPU_CHILD;
// host-cpu-child")
GQuark FU_DEVICE_PRIVATE_FLAG_EXPLICIT_ORDER;
// explicit-order")
GQuark FU_DEVICE_PRIVATE_FLAG_REFCOUNTED_PROXY;
// refcounted-proxy")
GQuark FU_DEVICE_PRIVATE_FLAG_USE_PROXY_FOR_OPEN;
// use-proxy-for-open")
GQuark FU_DEVICE_PRIVATE_FLAG_INSTALL_PARENT_FIRST;
// install-parent-first")
GQuark FU_DEVICE_PRIVATE_FLAG_REGISTERED;
// registered")
GQuark FU_DEVICE_PRIVATE_FLAG_ADD_COUNTERPART_GUIDS;
// add-counterpart-guids")
GQuark FU_DEVICE_PRIVATE_FLAG_USE_RUNTIME_VERSION;
// use-runtime-version")
GQuark FU_DEVICE_PRIVATE_FLAG_SKIPS_RESTART;
// skips-restart")
GQuark FU_DEVICE_PRIVATE_FLAG_IS_FAKE;
// is-fake")
GQuark FU_DEVICE_PRIVATE_FLAG_COUNTERPART_VISIBLE;
// counterpart-visible")
GQuark FU_DEVICE_PRIVATE_FLAG_DETACH_PREPARE_FIRMWARE;
// detach-prepare-firmware")
GQuark FU_DEVICE_PRIVATE_FLAG_EMULATED_REQUIRE_SETUP;
// emulated-require-setup")
GQuark FU_DEVICE_PRIVATE_FLAG_INSTALL_LOOP_RESTART;
// install-loop-restart")
GQuark FU_DEVICE_PRIVATE_FLAG_MD_SET_REQUIRED_FREE;
// md-set-required-free")
...
static gboolean
fu_device_private_flags_has_quark(FuDevice *self, GQuark flag_quark)
{
	FuDevicePrivate *priv = GET_PRIVATE(self);
...
static gboolean
fu_device_private_flags_add_quark(FuDevice *self, GQuark flag_quark)
{
	FuDevicePrivate *priv = GET_PRIVATE(self);
	if (fu_device_private_flags_has_quark(self, flag_quark) != 0)
		return FALSE;
...
static gboolean
fu_device_private_flags_remove_quark(FuDevice *self, GQuark flag_quark)
{
	FuDevicePrivate *priv = GET_PRIVATE(self);
	for (guint i = 0; i < priv->private_flags->len; i++) {
		GQuark flag_tmp = g_array_index(priv->private_flags, GQuark, i);
 ...
 **/
void
fu_device_add_private_flag(FuDevice *self, GQuark flag)
{
	FuDevicePrivate *priv = GET_PRIVATE(self);
	...
	if (flag == FU_DEVICE_PRIVATE_FLAG_EXPLICIT_ORDER) {
	...
	/* exists */
	if (fu_device_private_flags_add_quark(self, flag))
 ...
 **/
void
fu_device_remove_private_flag(FuDevice *self, GQuark flag)
{
	g_return_if_fail(FU_IS_DEVICE(self));
	g_return_if_fail(flag != 0);
	...
	if (fu_device_private_flags_remove_quark(self, flag))
		g_object_notify(G_OBJECT(self), "private-flags");
}
 ...
 **/
gboolean
fu_device_has_private_flag(FuDevice *self, GQuark flag)
{
	g_return_val_if_fail(FU_IS_DEVICE(self), FALSE);
	g_return_val_if_fail(flag != 0, FALSE);

	return fu_device_private_flags_has_quark(self, flag);
}
...
fu_device_set_custom_flag(FuDevice *self, const gchar *hint)
{
	...
	if (g_str_has_prefix(hint, "~")) {
		...
		flag_quark = g_quark_try_string(hint + 1);
		if (flag_quark != 0) {
			fu_device_private_flags_remove_quark(self, flag_quark);
			return;
		}
		return;
	}
	...
	flag_quark = g_quark_try_string(hint);
	if (flag_quark != 0) {
		fu_device_private_flags_add_quark(self, flag_quark);
		return;
	}
}
	...
	if (priv->instance_ids != NULL) {
		for (guint i = 0; i < priv->instance_ids->len; i++) {
			...
			if ((item->flags & FU_DEVICE_INSTANCE_FLAG_VISIBLE) == 0)
				continue;
			if ((item->flags & FU_DEVICE_INSTANCE_FLAG_GENERIC) > 0 &&
			    fu_device_has_private_flag(self,
...
fu_device_class_init(FuDeviceClass *klass)
{
	...
	FU_DEVICE_PRIVATE_FLAG_NO_AUTO_INSTANCE_IDS =
	    g_quark_from_static_string("no-auto-instance-ids");
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_ENSURE_SEMVER, "ensure-semver")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_ONLY_SUPPORTED, "only-supported")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_NAME, "md-set-name")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_NAME_CATEGORY, "md-set-name-category")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_VERFMT, "md-set-verfmt")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_ICON, "md-set-icon")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_RETRY_OPEN, "retry-open")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_REPLUG_MATCH_GUID, "replug-match-guid")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_INHERIT_ACTIVATION, "inherit-activation")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_IS_OPEN, "is-open")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_NO_SERIAL_NUMBER, "no-serial-number")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_AUTO_PARENT_CHILDREN, "auto-parent-children")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_ATTACH_EXTRA_RESET, "attach-extra-reset")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_INHIBIT_CHILDREN, "inhibit-children")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_NO_AUTO_REMOVE_CHILDREN, "no-auto-remove-children")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_USE_PARENT_FOR_OPEN, "use-parent-for-open")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_USE_PARENT_FOR_BATTERY, "use-parent-for-battery")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_USE_PROXY_FALLBACK, "use-proxy-fallback")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_NO_AUTO_REMOVE, "no-auto-remove")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_VENDOR, "md-set-vendor")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_NO_LID_CLOSED, "no-lid-closed")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_NO_PROBE, "no-probe")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_SIGNED, "md-set-signed")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_AUTO_PAUSE_POLLING, "auto-pause-polling")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_DELAYED_REMOVAL, "delayed-removal")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_IGNORE_SYSTEM_POWER, "ignore-system-power")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_SAVE_INTO_BACKUP_REMOTE, "save-into-backup-remote")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_FLAGS, "md-set-flags")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_VERSION, "md-set-version")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_ONLY_CHECKSUM, "md-only-checksum")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_ADD_INSTANCE_ID_REV, "add-instance-id-rev")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_UNCONNECTED, "unconnected")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_DISPLAY_REQUIRED, "display-required")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_UPDATE_PENDING, "update-pending")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_NO_GENERIC_GUIDS, "no-generic-guids")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_ENFORCE_REQUIRES, "enforce-requires")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_HOST_FIRMWARE, "host-firmware")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_HOST_FIRMWARE_CHILD, "host-firmware-child")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_HOST_CPU, "host-cpu")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_HOST_CPU_CHILD, "host-cpu-child")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_EXPLICIT_ORDER, "explicit-order")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_REFCOUNTED_PROXY, "refcounted-proxy")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_USE_PROXY_FOR_OPEN, "use-proxy-for-open")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_INSTALL_PARENT_FIRST, "install-parent-first")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_REGISTERED, "registered")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_ADD_COUNTERPART_GUIDS, "add-counterpart-guids")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_USE_RUNTIME_VERSION, "use-runtime-version")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_SKIPS_RESTART, "skips-restart")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_IS_FAKE, "is-fake")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_COUNTERPART_VISIBLE, "counterpart-visible")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_DETACH_PREPARE_FIRMWARE, "detach-prepare-firmware")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_EMULATED_REQUIRE_SETUP, "emulated-require-setup")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_INSTALL_LOOP_RESTART, "install-loop-restart")
	FU_DEFINE_QUARK2(FU_DEVICE_PRIVATE_FLAG_MD_SET_REQUIRED_FREE, "md-set-required-free")

...
const struct {
    ...
    {FWUPD_SECURITY_ATTR_ID_INTEL_SPI_PROTECTED_REGIONS, FWUPD_SECURITY_ATTR_LEVEL_IMPORTANT},
...
const struct {
    ...
    {FWUPD_SECURITY_ATTR_ID_COREBOOT_VBOOT, "2.1.5"},
    ...
    {FWUPD_SECURITY_ATTR_ID_INTEL_SPI_PROTECTED_REGIONS, "2.1.5"},

...
guint8
fu_hid_device_get_interface(FuHidDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fu_hid_device_set_ep_addr_in(FuHidDevice *self, guint8 ep_addr_in) G_GNUC_NON_NULL(1);
guint8
fu_hid_device_get_ep_addr_in(FuHidDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fu_hid_device_set_ep_addr_out(FuHidDevice *self, guint8 ep_addr_out) G_GNUC_NON_NULL(1);
guint8
fu_hid_device_get_ep_addr_out(FuHidDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
GPtrArray *

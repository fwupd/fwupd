...
static gboolean
fu_usb_config_descriptor_from_json(FwupdCodec *codec, FwupdJsonObject *json_object, GError **error)
{
				  ...
				  FwupdCodecFlags flags)
{
	...
	if (self->configuration != 0)
		fwupd_json_object_add_integer(json_object, "Configuration", self->configuration);

...
fu_msgpack_item_parse(GByteArray *buf, gsize *offset, GError **error)
{
	...
	if (!fu_size_checked_inc(offset, 1, error)) {
		g_prefix_error_literal(error, "msgpack command offset overflow: ");
		return NULL;
	}
	...
	if (cmd == FU_MSGPACK_CMD_UINT8) {
		...
		if (!fu_size_checked_inc(offset, sizeof(v), error)) {
			g_prefix_error_literal(error, "msgpack uint8 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_UINT16) {
		...
		if (!fu_size_checked_inc(offset, sizeof(v), error)) {
			g_prefix_error_literal(error, "msgpack uint16 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_UINT32) {
		...
		if (!fu_size_checked_inc(offset, sizeof(v), error)) {
			g_prefix_error_literal(error, "msgpack uint32 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_UINT64) {
		...
		if (!fu_size_checked_inc(offset, sizeof(v), error)) {
			g_prefix_error_literal(error, "msgpack uint64 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_FLOAT64) {
		...
		if (!fu_size_checked_inc(offset, sizeof(v), error)) {
			g_prefix_error_literal(error, "msgpack float64 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_ARRAY16) {
		...
		if (!fu_size_checked_inc(offset, sizeof(n), error)) {
			g_prefix_error_literal(error, "msgpack array16 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_ARRAY32) {
		...
		if (!fu_size_checked_inc(offset, sizeof(n), error)) {
			g_prefix_error_literal(error, "msgpack array32 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_MAP16) {
		...
		if (!fu_size_checked_inc(offset, sizeof(n), error)) {
			g_prefix_error_literal(error, "msgpack map16 offset overflow: ");
			return NULL;
		}
	...
	if (cmd == FU_MSGPACK_CMD_MAP32) {
		...
		if (!fu_size_checked_inc(offset, sizeof(n), error)) {
			g_prefix_error_literal(error, "msgpack map32 offset overflow: ");
			return NULL;
		}

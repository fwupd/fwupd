...
#define FU_USB_DEVICE_CLASS_APPLICATION_SPECIFIC G_USB_DEVICE_CLASS_APPLICATION_SPECIFIC
#define FU_USB_DEVICE_CLASS_AUDIO		 G_USB_DEVICE_CLASS_AUDIO
#define FU_USB_DEVICE_CLASS_AUDIO_VIDEO		 G_USB_DEVICE_CLASS_AUDIO_VIDEO
#define FU_USB_DEVICE_CLASS_BILLBOARD		 G_USB_DEVICE_CLASS_BILLBOARD
#define FU_USB_DEVICE_CLASS_CDC_DATA		 G_USB_DEVICE_CLASS_CDC_DATA
#define FU_USB_DEVICE_CLASS_COMMUNICATIONS	 G_USB_DEVICE_CLASS_COMMUNICATIONS
#define FU_USB_DEVICE_CLASS_CONTENT_SECURITY	 G_USB_DEVICE_CLASS_CONTENT_SECURITY
#define FU_USB_DEVICE_CLASS_DIAGNOSTIC		 G_USB_DEVICE_CLASS_DIAGNOSTIC
#define FU_USB_DEVICE_CLASS_HID			 G_USB_DEVICE_CLASS_HID
#define FU_USB_DEVICE_CLASS_HUB			 G_USB_DEVICE_CLASS_HUB
#define FU_USB_DEVICE_CLASS_IMAGE		 G_USB_DEVICE_CLASS_IMAGE
#define FU_USB_DEVICE_CLASS_INTERFACE_DESC	 G_USB_DEVICE_CLASS_INTERFACE_DESC
#define FU_USB_DEVICE_CLASS_MASS_STORAGE	 G_USB_DEVICE_CLASS_MASS_STORAGE
#define FU_USB_DEVICE_CLASS_MISCELLANEOUS	 G_USB_DEVICE_CLASS_MISCELLANEOUS
#define FU_USB_DEVICE_CLASS_PERSONAL_HEALTHCARE	 G_USB_DEVICE_CLASS_PERSONAL_HEALTHCARE
#define FU_USB_DEVICE_CLASS_PHYSICAL		 G_USB_DEVICE_CLASS_PHYSICAL
#define FU_USB_DEVICE_CLASS_PRINTER		 G_USB_DEVICE_CLASS_PRINTER
#define FU_USB_DEVICE_CLASS_SMART_CARD		 G_USB_DEVICE_CLASS_SMART_CARD
#define FU_USB_DEVICE_CLASS_VENDOR_SPECIFIC	 G_USB_DEVICE_CLASS_VENDOR_SPECIFIC
#define FU_USB_DEVICE_CLASS_VIDEO		 G_USB_DEVICE_CLASS_VIDEO
#define FU_USB_DEVICE_CLASS_WIRELESS_CONTROLLER	 G_USB_DEVICE_CLASS_WIRELESS_CONTROLLER

...
* snapcraft.yaml This uses tarball releases for all dependencies and
what is currently in tree for fwupd.
* snapcraft-master.yaml This uses git for most dependencies and may be
considered unstable.
...
A ``classic'' snap is produced, and locally built snaps can be installed
like this:

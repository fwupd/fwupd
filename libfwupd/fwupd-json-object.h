...
GRefString *
fwupd_json_object_get_key_for_index(FwupdJsonObject *self, guint idx, GError **error) G_GNUC_NON_NULL(1);
GPtrArray *
fwupd_json_object_get_keys(FwupdJsonObject *self) G_GNUC_NON_NULL(1) G_GNUC_WARN_UNUSED_RESULT;
FwupdJsonNode *
fwupd_json_object_get_node_for_index(FwupdJsonObject *self, guint idx, GError **error) G_GNUC_NON_NULL(1);
GPtrArray *

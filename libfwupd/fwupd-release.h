...
const gchar *
fwupd_release_get_version(FwupdRelease *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
fwupd_release_has_flag(FwupdRelease *self,
		       FwupdReleaseFlags flag) G_GNUC_WARN_UNUSED_RESULT G_GNUC_PURE;
FwupdReleaseUrgency
fwupd_release_get_urgency(FwupdRelease *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_release_set_urgency(FwupdRelease *self, FwupdReleaseUrgency urgency) G_GNUC_NON_NULL(1);
guint32
fwupd_release_get_install_duration(FwupdRelease *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_release_set_install_duration(FwupdRelease *self, guint32 duration) G_GNUC_NON_NULL(1);
const gchar *
fwupd_release_get_update_message(FwupdRelease *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_release_set_update_message(FwupdRelease *self, const gchar *update_message)
    G_GNUC_NON_NULL(1);
const gchar *
fwupd_release_get_update_image(FwupdRelease *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void

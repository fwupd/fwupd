...
const gchar *
fwupd_device_get_id(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
gchar *
...
const gchar *
fwupd_device_get_parent_id(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_device_set_parent_id(FwupdDevice *self, const gchar *parent_id) G_GNUC_NON_NULL(1);
const gchar *
fwupd_device_get_composite_id(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_device_set_composite_id(FwupdDevice *self, const gchar *composite_id) G_GNUC_NON_NULL(1);
FwupdDevice *
fwupd_device_get_root(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
FwupdDevice *
fwupd_device_get_parent(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
guint64
fwupd_device_get_problems(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
fwupd_device_has_problem(FwupdDevice *self, FwupdDeviceProblem problem) G_GNUC_WARN_UNUSED_RESULT
    G_GNUC_NON_NULL(1) G_GNUC_PURE;
guint64
fwupd_device_get_request_flags(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
fwupd_device_has_request_flag(FwupdDevice *self,
    ...
    G_GNUC_NON_NULL(1) G_GNUC_PURE;
guint64
fwupd_device_get_created(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_device_set_created(FwupdDevice *self, guint64 created) G_GNUC_NON_NULL(1);
guint64
fwupd_device_get_modified(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
const gchar *
fwupd_device_get_plugin(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
const gchar *
fwupd_device_get_vendor(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
const gchar *
fwupd_device_get_guid_default(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
FwupdUpdateState
fwupd_device_get_update_state(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_device_set_update_state(FwupdDevice *self, FwupdUpdateState update_state) G_GNUC_NON_NULL(1);
const gchar *
fwupd_device_get_update_error(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_device_set_update_error(FwupdDevice *self, const gchar *update_error) G_GNUC_NON_NULL(1);
FwupdStatus
fwupd_device_get_status(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
fwupd_device_set_status(FwupdDevice *self, FwupdStatus status) G_GNUC_NON_NULL(1);
guint
fwupd_device_get_percentage(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
void
...
FwupdRelease *
fwupd_device_get_release_default(FwupdDevice *self) G_GNUC_NON_NULL(1) G_GNUC_PURE;
gint
fwupd_device_compare(FwupdDevice *self1, FwupdDevice *self2) G_GNUC_NON_NULL(1, 2) G_GNUC_PURE;
gboolean

...
struct _FwupdCodecInterface {
	...
	void (*add_json)(FwupdCodec *self, FwupdJsonObject *json_object, FwupdCodecFlags flags);
	gboolean (*from_json)(FwupdCodec *self, FwupdJsonObject *json_object, GError **error);

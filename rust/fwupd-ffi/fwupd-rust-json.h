...
fwupd_rs_json_parser_load_from_bytes(const FwupdRsJsonParser *ptr,
				     ...
				     GError **error);
FwupdRsJsonNode *
fwupd_rs_json_parser_load_from_stream(const FwupdRsJsonParser *ptr,
				      FuRsExternalStreamHandle handle,
				      FuRsStreamCallbacks callbacks,
				      guint flags,
				      GError **error);
FwupdRsJsonNode *
fwupd_rs_json_parser_load_from_stream_impl(const FwupdRsJsonParser *ptr,
					   FuRsStreamImpl *stream_impl,
					   guint flags,
					   GError **error);

...
mod tests {
    ...
    fn compressor_roundtrip_all_formats() {
        ...
        for format in [
            ...
            assert!(
                !compressed.is_empty(),
                "compressor produced no output for {:?}",
                format
            );
    ...
    fn decompress_stream_reads_compressor_output() {
        ...
        for format in [
            ...
            assert_eq!(
                decompressed, data,
                "DecompressorStream couldn't read compressor output for {:?}",
                format
            );
        }
    }
    ...
    fn compressor_stream_output_readable_by_decompress() {
        ...
        for format in [
            ...
            assert_eq!(
                decompressed, data,
                "compressor::decompress couldn't read CompressorStream output for {:?}",
                format
            );
        }
    }
